    ...
    <section className="w-full py-20">
        ...
        <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
            <Card
                ...
                description="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean a vulputate ligula, a pharetra ligula. Aliquam non viverra tortor. Morbi non dapibus dui, nec ultricies risus."
                >
                <CanvasRevealEffect
                    animationSpeed={5.1}
